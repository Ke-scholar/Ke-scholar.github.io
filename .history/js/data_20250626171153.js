    ...
    works: [
        {
            ...
            coverImg: "img/works/sukasuka_cover.jpg",
            totalCharacters: 3
        },
        {
            id: "rezero",
        ...
        sukasuka: [ // 对应作品ID
            {
                ...
                name: "珂朵莉",
                description: "黄金妖精",
                coverImg: "img/characters/Chtholly_cover.jpg",
                totalImages: 42
            },
            // 其他角色...
        ],
...
function getAllWorks() {
  return galleimageDataryData.works;
}

function getWorkById(id) {
  return galleryData.works.find(work => work.id === id);
}

function getCharactersByWork(workId) {
  return galleryData.characters[workId] || [];
}
